...
class rshdmr():
    ...
    def __init__(self,data_file, poly_order=8 ,regression_type = 'lasso',**kwargs):
        ...
        self._min_best_neurons_count=40
        self._n_jobs = -1
    ...
    def stats(self):
        ...
        data = {"mae:":mae, "mse:":mse, "evs:":evs, "slope:":slope, "std error:": std_err}
        return data
